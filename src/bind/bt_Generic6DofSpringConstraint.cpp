...
static int btGeneric6DofSpringConstraint__btGeneric6DofSpringConstraint(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.Generic6DofSpringConstraint"));
    if (userdata->gc) {
...
static int btGeneric6DofSpringConstraint__cast_(lua_State *L) {
  ...
  btGeneric6DofSpringConstraint *self = *((btGeneric6DofSpringConstraint **)dub_checksdata_n(L, 1, "bt.Generic6DofSpringConstraint"));
...
static int btGeneric6DofSpringConstraint_setStiffness(lua_State *L) {
  try {
    btGeneric6DofSpringConstraint *self = *((btGeneric6DofSpringConstraint **)dub_checksdata(L, 1, "bt.Generic6DofSpringConstraint"));
    int index = dub_checkint(L, 2);
    btScalar stiffness = dub_checknumber(L, 3);
...
static int btGeneric6DofSpringConstraint_setLinearLowerLimit(lua_State *L) {
  try {
    btGeneric6DofSpringConstraint *self = *((btGeneric6DofSpringConstraint **)dub_checksdata(L, 1, "bt.Generic6DofSpringConstraint"));
    btVector3 *linearLower = *((btVector3 **)dub_checksdata(L, 2, "bt.Vector3"));
...
static int btGeneric6DofSpringConstraint_setLinearUpperLimit(lua_State *L) {
  try {
    btGeneric6DofSpringConstraint *self = *((btGeneric6DofSpringConstraint **)dub_checksdata(L, 1, "bt.Generic6DofSpringConstraint"));
    btVector3 *linearUpper = *((btVector3 **)dub_checksdata(L, 2, "bt.Vector3"));
...
static int btGeneric6DofSpringConstraint_setAngularLowerLimit(lua_State *L) {
  try {
    btGeneric6DofSpringConstraint *self = *((btGeneric6DofSpringConstraint **)dub_checksdata(L, 1, "bt.Generic6DofSpringConstraint"));
    btVector3 *angularLower = *((btVector3 **)dub_checksdata(L, 2, "bt.Vector3"));
...
static int btGeneric6DofSpringConstraint_setAngularUpperLimit(lua_State *L) {
  try {
    btGeneric6DofSpringConstraint *self = *((btGeneric6DofSpringConstraint **)dub_checksdata(L, 1, "bt.Generic6DofSpringConstraint"));
    btVector3 *angularUpper = *((btVector3 **)dub_checksdata(L, 2, "bt.Vector3"));
...
extern "C" int luaopen_bt_Generic6DofSpringConstraint(lua_State *L)
{
  ...
  luaL_register(L, NULL, btGeneric6DofSpringConstraint_member_methods);
  // save meta-table in bt
  dub_register(L, "bt", "Generic6DofSpringConstraint", "Generic6DofSpringConstraint");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
