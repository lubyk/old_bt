...
static int btSphereShape__btSphereShape(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.SphereShape"));
    if (userdata->gc) {
    ...
    lua_pushfstring(L, "~btSphereShape: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "~btSphereShape: Unknown exception");
  }
  return dub_error(L);
}
...
static int btSphereShape__cast_(lua_State *L) {
  ...
  btSphereShape *self = *((btSphereShape **)dub_checksdata_n(L, 1, "bt.SphereShape"));
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btSphereShape.h:30
 */
static int btSphereShape_btSphereShape(lua_State *L) {
  try {
    btScalar radius = dub_checknumber(L, 1);
    btSphereShape *retval__ = new btSphereShape(radius);
    dub_pushudata(L, retval__, "bt.SphereShape", true);
    return 1;
  } catch (std::exception &e) {
    lua_pushfstring(L, "btSphereShape: %s", e.what());
  } catch (...) {
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btSphereShape.h:50
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btSphereShape.h:59
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btSphereShape.h:63
 */
...
extern "C" int luaopen_bt_SphereShape(lua_State *L)
{
  ...
  luaL_register(L, NULL, btSphereShape_member_methods);
  // save meta-table in bt
  dub_register(L, "bt", "SphereShape", "SphereShape");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
