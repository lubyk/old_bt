...
static int btIDebugDraw__btIDebugDraw(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.IDebugDraw"));
    if (userdata->gc) {
    ...
    lua_pushfstring(L, "~btIDebugDraw: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "~btIDebugDraw: Unknown exception");
  }
  return dub_error(L);
}
...
static int btIDebugDraw_drawLine(lua_State *L) {
  try {
    btIDebugDraw *self = *((btIDebugDraw **)dub_checksdata(L, 1, "bt.IDebugDraw"));
...
static int btIDebugDraw_drawSphere(lua_State *L) {
  try {
    ...
    if (type__ == LUA_TNUMBER) {
      ...
      btTransform *transform = *((btTransform **)dub_checksdata(L, 3, "bt.Transform"));
      btVector3 *color = *((btVector3 **)dub_checksdata(L, 4, "bt.Vector3"));
...
static int btIDebugDraw_drawTriangle(lua_State *L) {
  try {
    ...
    if (top__ >= 9) {
      ...
      btVector3 *p4 = *((btVector3 **)dub_checksdata(L, 5, "bt.Vector3"));
      btVector3 *p5 = *((btVector3 **)dub_checksdata(L, 6, "bt.Vector3"));
      btVector3 *p6 = *((btVector3 **)dub_checksdata(L, 7, "bt.Vector3"));
      btVector3 *color = *((btVector3 **)dub_checksdata(L, 8, "bt.Vector3"));
      btScalar alpha = dub_checknumber(L, 9);
      ...
      btScalar p5 = dub_checknumber(L, 6);
 ...
 * src/vendor/bullet/src/LinearMath/btIDebugDraw.h:109
 */
 ...
 * src/vendor/bullet/src/LinearMath/btIDebugDraw.h:111
 */
 ...
 * src/vendor/bullet/src/LinearMath/btIDebugDraw.h:113
 */
 ...
 * src/vendor/bullet/src/LinearMath/btIDebugDraw.h:115
 */
 ...
 * src/vendor/bullet/src/LinearMath/btIDebugDraw.h:117
 */
...
static int btIDebugDraw___tostring(lua_State *L) {
  btIDebugDraw *self = *((btIDebugDraw **)dub_checksdata_n(L, 1, "bt.IDebugDraw"));
...
// --=============================================== CONSTANTS
static const struct dub_const_Reg btIDebugDraw_const[] = {
...
extern "C" int luaopen_bt_IDebugDraw(lua_State *L)
{
  ...
  dub_register_const(L, btIDebugDraw_const);

  // register member methods
  luaL_register(L, NULL, btIDebugDraw_member_methods);
  // save meta-table in bt
  dub_register(L, "bt", "IDebugDraw", "IDebugDraw");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
