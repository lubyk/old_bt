...
static int btPolyhedralConvexShape__btPolyhedralConvexShape(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.PolyhedralConvexShape"));
    if (userdata->gc) {
    ...
    lua_pushfstring(L, "~btPolyhedralConvexShape: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "~btPolyhedralConvexShape: Unknown exception");
  }
  return dub_error(L);
}
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btConvexInternalShape.h:89
 */
