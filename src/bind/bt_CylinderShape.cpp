...
static int btCylinderShape__btCylinderShape(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.CylinderShape"));
    if (userdata->gc) {
...
static int btCylinderShape__cast_(lua_State *L) {
  ...
  btCylinderShape *self = *((btCylinderShape **)dub_checksdata_n(L, 1, "bt.CylinderShape"));
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:37
 */
static int btCylinderShape_getHalfExtentsWithMargin(lua_State *L) {
  try {
    btCylinderShape *self = *((btCylinderShape **)dub_checksdata(L, 1, "bt.CylinderShape"));
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:45
 */
...
static int btCylinderShape_btCylinderShape(lua_State *L) {
  try {
    btVector3 *halfExtents = *((btVector3 **)dub_checksdata(L, 1, "bt.Vector3"));
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:60
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:72
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:96
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:101
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:108
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:113
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btCylinderShape.h:126
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btConvexInternalShape.h:124
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btConvexInternalShape.h:129
 */
...
extern "C" int luaopen_bt_CylinderShape(lua_State *L)
{
  ...
  luaL_register(L, NULL, btCylinderShape_member_methods);
  // save meta-table in bt
  dub_register(L, "bt", "CylinderShape", "CylinderShape");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
