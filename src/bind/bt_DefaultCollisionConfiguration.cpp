 ...
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btDefaultCollisionConfiguration.h:93
 */
static int btDefaultCollisionConfiguration_btDefaultCollisionConfiguration(lua_State *L) {
  try {
    int top__ = lua_gettop(L);
    if (top__ >= 1) {
      btDefaultCollisionConstructionInfo *constructionInfo = *((btDefaultCollisionConstructionInfo **)dub_checksdata(L, 1, "bt.DefaultCollisionConstructionInfo"));
      btDefaultCollisionConfiguration *retval__ = new btDefaultCollisionConfiguration(*constructionInfo);
      dub_pushudata(L, retval__, "bt.DefaultCollisionConfiguration", true);
      return 1;
    } else {
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btDefaultCollisionConfiguration.h:95
 */
static int btDefaultCollisionConfiguration__btDefaultCollisionConfiguration(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.DefaultCollisionConfiguration"));
    if (userdata->gc) {
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btDefaultCollisionConfiguration.h:104
 */
...
/** virtual btStackAlloc* btDefaultCollisionConfiguration::getStackAllocator()
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btDefaultCollisionConfiguration.h:109
 */
static int btDefaultCollisionConfiguration_getStackAllocator(lua_State *L) {
  try {
    btDefaultCollisionConfiguration *self = *((btDefaultCollisionConfiguration **)dub_checksdata(L, 1, "bt.DefaultCollisionConfiguration"));
    ...
    lua_pushfstring(L, "getStackAllocator: Unknown exception");
  }
  return dub_error(L);
}

/** virtual btVoronoiSimplexSolver* btDefaultCollisionConfiguration::getSimplexSolver()
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btDefaultCollisionConfiguration.h:114
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btDefaultCollisionConfiguration.h:128
 */
...
static const struct luaL_Reg btDefaultCollisionConfiguration_member_methods[] = {
  ...
  { "getStackAllocator", btDefaultCollisionConfiguration_getStackAllocator },
