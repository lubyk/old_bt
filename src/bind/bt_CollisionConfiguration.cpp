 ...
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btCollisionConfiguration.h:33
 */
static int btCollisionConfiguration__btCollisionConfiguration(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.CollisionConfiguration"));
    if (userdata->gc) {
    ...
    lua_pushfstring(L, "~btCollisionConfiguration: %s", e.what());
  } catch (...) {
    lua_pushfstring(L, "~btCollisionConfiguration: Unknown exception");
  }
  return dub_error(L);
}

/** virtual btPoolAllocator* btCollisionConfiguration::getPersistentManifoldPool()=0
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btCollisionConfiguration.h:37
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btCollisionConfiguration.h:39
 */
...
/** virtual btStackAlloc* btCollisionConfiguration::getStackAllocator()=0
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btCollisionConfiguration.h:41
 */
static int btCollisionConfiguration_getStackAllocator(lua_State *L) {
  try {
    btCollisionConfiguration *self = *((btCollisionConfiguration **)dub_checksdata(L, 1, "bt.CollisionConfiguration"));
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionDispatch/btCollisionConfiguration.h:43
 */
...
static int btCollisionConfiguration___tostring(lua_State *L) {
  btCollisionConfiguration *self = *((btCollisionConfiguration **)dub_checksdata_n(L, 1, "bt.CollisionConfiguration"));
...
static const struct luaL_Reg btCollisionConfiguration_member_methods[] = {
  ...
  { "getStackAllocator", btCollisionConfiguration_getStackAllocator },
...
extern "C" int luaopen_bt_CollisionConfiguration(lua_State *L)
{
  ...
  luaL_register(L, NULL, btCollisionConfiguration_member_methods);
  // save meta-table in bt
  dub_register(L, "bt", "CollisionConfiguration", "CollisionConfiguration");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
