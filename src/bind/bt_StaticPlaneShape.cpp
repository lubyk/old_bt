...
static int btStaticPlaneShape__cast_(lua_State *L) {
  ...
  btStaticPlaneShape *self = *((btStaticPlaneShape **)dub_checksdata_n(L, 1, "bt.StaticPlaneShape"));
...
static int btStaticPlaneShape_btStaticPlaneShape(lua_State *L) {
  try {
    btVector3 *planeNormal = *((btVector3 **)dub_checksdata(L, 1, "bt.Vector3"));
    btScalar planeConstant = dub_checknumber(L, 2);
...
static int btStaticPlaneShape__btStaticPlaneShape(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub_checksdata_d(L, 1, "bt.StaticPlaneShape"));
    if (userdata->gc) {
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btStaticPlaneShape.h:51
 */
static int btStaticPlaneShape_getPlaneNormal(lua_State *L) {
  try {
    btStaticPlaneShape *self = *((btStaticPlaneShape **)dub_checksdata(L, 1, "bt.StaticPlaneShape"));
    dub_pushudata(L, const_cast<btVector3*>(&self->getPlaneNormal()), "bt.Vector3", false);
    return 1;
  } catch (std::exception &e) {
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btStaticPlaneShape.h:56
 */
 ...
 * src/vendor/bullet/src/BulletCollision/CollisionShapes/btConcaveShape.h:54
 */
...
extern "C" int luaopen_bt_StaticPlaneShape(lua_State *L)
{
  ...
  luaL_register(L, NULL, btStaticPlaneShape_member_methods);
  // save meta-table in bt
  dub_register(L, "bt", "StaticPlaneShape", "StaticPlaneShape");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
